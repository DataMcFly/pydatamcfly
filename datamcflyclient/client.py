...
class DataMcFlyClient(object):
    ...
    then :class:`DataMcFlyClient` gets system proxy settings.
    ...
    def __init__(self, api_key, version=settings.VERSION_1, proxy_url=None):
        ...
        self.settings = settings.DataMcFlySettings(version)
    ...
    def list_documents(self, database, collection, **kwargs):
        ...
        .. code-block:: bash
           ...
           GET /apps/{database}/collections/{collection}
        """
    ...
    def insert_documents(self, database, collection, doc_or_docs):
        ...
        .. code-block:: bash
           ...
           POST /apps/{database}/collections/{collection}
        """
    ...
    def update_documents(self, database, collection, spec, doc_or_docs, upsert,
        ...
        .. code-block:: bash
           ...
           PUT /apps/{database}/collections/{collection}
        """
    ...
    def view_document(self, database, collection, _id):
        ...
        .. code-block:: bash
           ...
           GET /apps/{database}/collections/{collection}/{_id}
        """
    ...
    def update_document(self, database, collection, _id, document):
        ...
        .. code-block:: bash
           ...
           PUT /apps/{database}/collections/{collection}/{_id}
        """
    ...
    def delete_document(self, database, collection, _id):
        ...
        .. code-block:: bash
           ...
           DELETE /apps/{database}/collections/{collection}/{_id}
        """
