...
from pydatamcfly import collection
...
class Database(object):
    ...
    def command(self, command, value=1, **kwargs):
        ...
        .. code-block:: python
           ...
           u'serverUsed': u'dsXXXXXX-b.datamcfly.com', u'lastExtentSize': 8192,
    ...
    def profiling_level(self):
        ...
        Returns one of (:data:`~pydatamcfly.OFF`,
        :data:`~pydatamcfly.SLOW_ONLY`, :data:`~pydatamcfly.ALL`).
    ...
    def set_profiling_level(self, level, slow_ms=None):
        ...
        | Level                         | Setting                            |
        +===============================+====================================+
        | :data:`~pydatamcfly.OFF`       | Off. No profiling.                 |
        +-------------------------------+------------------------------------+
        | :data:`~pydatamcfly.SLOW_ONLY` | On. Only includes slow operations. |
        +-------------------------------+------------------------------------+
        | :data:`~pydatamcfly.ALL`       | On. Includes all operations.       |
        +-------------------------------+------------------------------------+

        Raises :class:`ValueError` if level is not one of
        (:data:`~pydatamcfly.OFF`, :data:`~pydatamcfly.SLOW_ONLY`,
        :data:`~pydatamcfly.ALL`).
